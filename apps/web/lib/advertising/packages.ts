...
export const advertisingFaqs = [
  ...
  ['Is payment online or handled by sales?', 'Selected packages support secure self-service Stripe Checkout. Custom campaigns remain sales-assisted.'],
